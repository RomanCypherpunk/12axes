...
const IDS = new Set([
  "venezuela", "cuba", "costa-rica", "suica", "suecia",
  "alemanha", "franca", "uniao-europeia", "reino-unido", "hungria",
  "russia", "japao", "coreia-do-sul", "coreia-do-sul-de-park-chung-hee", "china",
]);
...
console.log(`Patched ${applied} countries (FQA036-038) in ${file}`);
