...
const IDS = new Set([
  "italia-fascista-mussolini", "chile-de-pinochet", "uniao-sovietica-urss", "china-maoista", "camboja-do-khmer-vermelho-pol-pot",
  "aragao-e-catalunha-anarquistas-revolucao-espanhola", "argentina-peronista", "egito-de-nasser", "africa-do-sul-do-apartheid", "hong-kong",
]);
...
console.log(`Patched ${applied} historical entities (FQA043-044) in ${file}`);
